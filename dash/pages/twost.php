<?php
		...
		$year = $year-1;
		$studs = mysqli_query($connect,"Select * from Students where Branch = '$branch' and Batch = '$year' and AttCoordiator = '$email' and RollNo not in (Select RollNo from Attendance where Month = '$month')");
		...
		if(isset($_POST['submit'])){
			...
			$n3 = $rid . "approve";
			$n3 = $_POST[$n3];
			$out = mysqli_query($connect,"Insert into Attendance values('$rid','$n1','$n2','$month','$n3')");
			if($out)
				header("location: onest.php");
		}
?>
<html lang="en">
<head>
