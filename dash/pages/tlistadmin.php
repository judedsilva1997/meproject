<?php
		...
		$teach = mysqli_query($connect,"Select * from Teachers");
		
		if(isset($_POST['sub'])){
			header("location: addadminteacher.php");
		}
		if(isset($_POST['ad'])){
			$em= $_POST['ad'];
			$add = mysqli_query($connect,"Insert into Role values ('$em',2)");
			if($add){
				header("location: tlistadmin.php");
			}
		}
?>
<html lang="en">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            List Of Teachers
							 ...
							 <form method = "post"><button type="submit" class="btn btn-default" name="sub">Add Teacher Admin</button>
							</form>	
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<form method = "Post">
								<?php
								 while ($result2 = mysqli_fetch_array($teach)){
									 $l1=$result2['Name'];
									 $l2=$result2['Email'];
									 $l3=$result2['Contact'];
									 $qur = mysqli_query($connect,"Select * from Role where Email = '$l2'");
									...
									if(mysqli_num_rows($qur)==0){
										echo "<button type=\"submit\" class=\"btn btn-default\" name=\"ad\" value=\"$l2\">Make Admin </button></td> ";
