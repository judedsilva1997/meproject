<?php
		...
		$year = $year-1;
		$studs = mysqli_query($connect,"Select * from Students where Branch = '$branch' and Batch = '$year' and Faculty = '$email' and RollNo not in (Select RollNo from Faculty where Month = '$month')");
		...
		if(isset($_POST['submit'])){
			...
			$n3 = $_POST[$n3];
			$n2 = $_POST[$n2];
			$out = mysqli_query($connect,"Insert into Faculty values('$rid','$n2','$month','$n3')");
			if($out)
