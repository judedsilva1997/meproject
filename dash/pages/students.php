<?php
		...
		$studs = mysqli_query($connect,"Select * from Students where Branch = '$branch'");
                 ...
                 <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							 ...
							 <form method = "post"><button type="submit" class="btn btn-default" name="sub">Add Student</button>
							</form>	
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Contact</th>
                                        <th>Batch</th>
                                        <!--<th>Att. Coordinator</th>-->
										<th>Guide</th>
										<th>TA Faculty</th>
										<th>ME Coordinator</th>
                                    </tr>
                                </thead>
                                <tbody>
								<?php
								 while ($result2 = mysqli_fetch_array($studs)){
									 ...
									 $l3=$result2['Contact'];
									 $l4=$result2['Batch'];
									 $l5=$result2['AttCoordiator'];
									 $l6=$result2['Guide'];
									 $l7=$result2['Faculty'];
									 $l8=$result2['MECoordinator'];
